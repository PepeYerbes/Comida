...
export class AppComponent {
  ...
  img5: string = "";
  img6: string = "";
  // Nueva imagen para Las Planchitas
  ...
  information5: string = "";
  information6: string = "";
  // Nuevo texto para Las Planchitas
  ...
  carrusel(op: number): void {
    ...
    switch (op) {
      ...
      case 3:
        ...
        break;
      case 4:
        this.img1 = "/tacobijado.jpg";
        this.information1 = "Taco con costra de queso encima <br> $70.00";
        this.img2 = "/tacos.jpg";
        this.information2 = "Taco Dorado <br> $30.00";
        this.img3 = "/torta.png";
        this.information3 = "Torta de barbacoa <br> 60.00";
        this.img4 = "/burro.jpg";
        this.information4 = "Burro Gigante de Barbacoa <br> $80.00";
        this.img5 = "/planchado.jpg";
        this.information5 = "Taco de Barbacoa a la Plancha <br> $60.00";
        this.img6 = "/consome.jpg";
        this.information6 = "Consome caliente de barbacoa <br> $20.00";
